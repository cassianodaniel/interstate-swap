...
export namespace $default {
  export interface GlobalCurrency extends std.$Object {
    "value": number;
    "value_float": number;
  }
...
import GlobalCurrency = $default.GlobalCurrency;
import Timestamped = $default.Timestamped;
export type {
  GlobalCurrency,
  Timestamped
};
...
export interface types {
  ...
  "default": {
    "GlobalCurrency": $default.GlobalCurrency;
