...
declare module '$env/static/private' {
	...
	export const npm_package_scripts_install_client: string;
	export const npm_package_devDependencies_postcss_load_config: string;
	export const npm_package_scripts_destroy: string;
	...
	export const npm_package_scripts_install_edgedb: string;
	export const USER: string;
	export const NVM_DIR: string;
	export const LS_COLORS: string;
	export const npm_package_devDependencies_zod: string;
	export const npm_package_scripts_build_both: string;
	...
	export const npm_package_scripts_migration_create: string;
	...
	export const npm_package_scripts_install_pnpm: string;
	...
	export const npm_package_scripts_migration_apply: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_scripts_install_client: string;
		npm_package_devDependencies_postcss_load_config: string;
		npm_package_scripts_destroy: string;
		...
		ZSH: string;
		PNPM_HOME: string;
		npm_package_scripts_install_edgedb: string;
		USER: string;
		NVM_DIR: string;
		LS_COLORS: string;
		npm_package_devDependencies_zod: string;
		npm_package_scripts_build_both: string;
		...
		PATH: string;
		npm_package_scripts_migration_create: string;
		...
		npm_package_scripts_install_pnpm: string;
		NODE_PATH: string;
		...
		npm_package_scripts_migration_apply: string;
